...
class BookingSpaScreen extends StatefulWidget {
  var hotel;
  var spa;
  var actvity;
  var product_id;
  ...
  @override
  State<BookingSpaScreen> createState() => _BookingSpaScreenState();
}

class _BookingSpaScreenState extends State<BookingSpaScreen>
    with BaseController {
  ...
  _getWorkingDays() async {
    await workingDayController.getActivityByCode(product_id: widget.product_id);
    // print(widget.hotel);
    // getDaysOff();
  }
  ...
  _getData() async {
    ...
    PostData.date.text = DateFormat('yyyy-MM-dd')
        ...
        .toString();
    await workingDayController.get_shifts_by_day_spa(
      restaurant_id: workingDayController.activity[0].id,
      day_name: day_name,
    ...
    return Scaffold(
      body: Obx(() {
        return (workingDayController.isLoaded.value == true)
            ? mainCompu()
            : LoadingScreen(img_name: 'wellness.jpg');
      }),
    );
  }
  ...
  Widget mainCompu() {
    return (working == true)
        ? Stack(
            children: [
              Image.asset(Img.get('wellness.jpg'),
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (_formKey.currentState!.validate()) {
                                          ...
                                          await workingDayController.bookSpa(
    ...
    return Container(
      ...
      child: Column(
        children: [
          restaurant_info(),
          Text(
            workingDayController.spaProduct[0].product_name,
          ...
          ClipRRect(
            ...
            child: Image.network(
              'https://yourcart.sunrise-resorts.com/assets/uploads/products/${workingDayController.spaProduct[0].logo}',
              height: 200,
              width: double.infinity,
              fit: BoxFit.fill,
            ),
